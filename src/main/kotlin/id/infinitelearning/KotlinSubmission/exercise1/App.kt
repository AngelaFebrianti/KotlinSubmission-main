 ...
 */
    fun myGroup(): String {
        val groupMembers = listOf("Haikal", "Devita", "Ahmad", "Angela", "Anniesyah")
...
fun main() {
     ...
     *
     */
    groupDetail(1, listOf("Haikal", "Devita", "Ahmad", "Angela", "Anniesyah"), "Afternoon")
